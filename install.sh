...
tampilan() {
    ...
    allowed_ips_url="https://raw.githubusercontent.com/Fitunnel/AutoScriptFull/main/ip"
...
echo ""
clear
REPO="https://raw.githubusercontent.com/Fitunnel/AutoScriptFull/main/"
start=$(date +%s)
secs_to_human() {
...
memasang_notifikasi_bot() {
  ...
  local izinsc="https://raw.githubusercontent.com/Fitunnel/AutoScriptFull/main/ip"
